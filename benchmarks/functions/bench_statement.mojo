...
@parameter
def bench_prepare(mut b: Bencher) raises:
...
@parameter
def bench_bind_positional(mut b: Bencher) raises:
...
@parameter
def bench_bind_named(mut b: Bencher) raises:
...
@parameter
def bench_reset_and_rebind(mut b: Bencher) raises:
